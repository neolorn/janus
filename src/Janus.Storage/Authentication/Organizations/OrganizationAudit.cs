...
/// CONV-DESIGN-003. The record is filed under the organization and carries the reason,
/// the domain where one changed, the invitation where one was issued or revoked, or the
/// membership where one ended; the actor is both identities, except that a membership
/// ended is done to its member.
/// </remarks>
