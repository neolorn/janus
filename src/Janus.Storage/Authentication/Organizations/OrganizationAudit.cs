...
/// <summary>
/// What a change to an organization's lifecycle or to its domain lock leaves in the
/// audit trail.
/// </summary>
/// <param name="records">Where the trail is appended to.</param>
/// <param name="time">The clock the deployment runs on.</param>
/// <remarks>
/// Implements IDN-ORG-003, REG-DOM-001, IDN-AUD-001 and CONV-DESIGN-003. The record is
/// filed under the organization and carries the reason, and the domain where one
/// changed; the actor is both identities.
/// </remarks>
