...
[Migration("20260922190710_MoveCollationToLibrarySchema")]
partial class MoveCollationToLibrarySchema
{
    /// <inheritdoc />
                ...
                b.ToTable("verification_codes", "identity", t =>
                    {
                        ...
                        t.HasCheckConstraint("ck_verification_codes_holder", "octet_length(holder) > 0");
                    });
            });
