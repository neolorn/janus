...
/// </summary>
/// <remarks>
/// Implements PRIV-BREACH-002 and CONV-DESIGN-003. The read takes the index on the
/// effective subject, so it answers without a scan of the trail.
/// </remarks>
internal interface IAuditTrailStore
{
    /// <summary>
    /// The records of one subject, most recent first.
    /// </summary>
