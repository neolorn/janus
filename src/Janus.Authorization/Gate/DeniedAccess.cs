...
/// <param name="Acting">Whose credentials the request was made under.</param>
/// <param name="Effective">Whose identity the request was made under.</param>
